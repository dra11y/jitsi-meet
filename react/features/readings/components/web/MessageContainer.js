...
/**
 * Displays all received readings messages, grouped by sender.
 *
...
export default class MessageContainer extends AbstractMessageContainer<Props> {
     ...
     * messages. Used for scrolling to the end of the readings messages.
     */
    _messagesListEndRef: Object;

    /**
     * A React ref to the HTML element containing all {@code ReadingsMessageGroup}
     * instances.
     */
    ...
    /**
     * Automatically scrolls the displayed readings messages down to the latest.
     *
