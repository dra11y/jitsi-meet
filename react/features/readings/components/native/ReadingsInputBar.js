...
/**
 * Implements the readings input bar with text field and action(s).
 */
class ReadingsInputBar extends Component<Props, State> {
    /**
        ...
        return (
            <View
                ...
                <TextInput
                    ...
                    placeholder = { this.props.t('readings.fieldPlaceHolder') }
...
export default translate(ReadingsInputBar);
